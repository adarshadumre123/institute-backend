...
router.get('/getAllQuestion',userAuth,roleMiddleware("teacher","admin"),getAllQuestions)
router.get('/getSingleQuestion',userAuth,roleMiddleware("teacher", "admin"),getSingleQuestion)
